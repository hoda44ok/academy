...
//     } finally {
//       logout(); // مسح التوكن من الـ AuthContext
//       navigate("/login");
//     }
//   };
...
//           <button
//             onClick={switchLang}
//             className="px-2 py-1 border rounded text-xs block"
//           >
...
//             <button
//               onClick={handleLogout}
//               className="block w-full text-red-600 font-medium py-1 text-sm"
//             >
//               {t("logout")}
//             </button>
//           )}
...
//   // Logout باستخدام AuthContext
//   const handleLogout = () => {
//     logout();       // الـ API يُستدعى داخل الـ context الآن
//     navigate("/login");
//   };
...
//                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 00-12 0v3.158c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
//               </svg>
//               {hasNew && <span className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full animate-pulse ring-2 ring-white"></span>}
//             </button>
